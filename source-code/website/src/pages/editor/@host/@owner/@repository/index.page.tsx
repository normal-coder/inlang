		...
		<Show when={successGeneratingConfig() !== false} fallback={<CouldntGenerateConfigCard />}>
			<div class="flex grow items-center justify-center">
				<div class="border border-outline p-8 rounded flex flex-col max-w-lg">
					...
					<p class="pt-1.5 pb-8">
						The inlang.config.js file has not been found at the root of the repository.
					</p>
					<Switch>
						<Match when={successGeneratingConfig() === undefined}>
							...
							>
								Generate the config file for me
							</sl-button>
						</Match>
					</Switch>
				</div>
	...
	return (
		<div class="flex grow items-center justify-center">
			<div class="border border-outline p-8 rounded flex flex-col max-w-lg">
				...
				<p class="pt-1.5 pb-8">Please refer to the documentation on how to get started.</p>
